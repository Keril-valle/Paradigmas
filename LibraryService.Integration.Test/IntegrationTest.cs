...
namespace LibraryService.Tests
{
    public class IntegrationTests : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        {
            var bookForm = new AddBookToLibraryCommand(libraryId, bookName, string.Empty);
        ...
        public async Task TestAddBook_Ok_GetBook_NotFound()
        {
            ...
            var bookForm = new AddBookToLibraryCommand(1, "Test book 1", string.Empty);
            ...
            bookForm = new AddBookToLibraryCommand(100, "Test book 2", string.Empty);
        ...
        public async Task TestGetBooks_Ok_NotFound()
        {
            ...
            var books = JsonConvert.DeserializeObject<IEnumerable<Book>>(await response1.Content.ReadAsStringAsync()) ?? Enumerable.Empty<Book>();
            books.ToList().Count.Should().Be(0);
            ...
            var books2 = JsonConvert.DeserializeObject<IEnumerable<Book>>(await response2.Content.ReadAsStringAsync()) ?? Enumerable.Empty<Book>();
